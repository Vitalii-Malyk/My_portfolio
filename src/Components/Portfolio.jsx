...
const Portfolio = () => {
  const data = [
    ...
    {
      name: "RentalCar",
      des: "Adaptive car rental application in Ukraine",
      live: "https://vitalii-malyk.github.io/UkraineDriveRentals/",
      github: "https://github.com/Vitalii-Malyk/UkraineDriveRentals",
      shot: "https://res.cloudinary.com/dlhwk4nof/image/upload/v1712937275/driveRental_pmnbux.png",
    },
    {
      name: "PowerPulse",
